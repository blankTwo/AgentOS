...
5. Run Documentation Gate: update README, AGENTS, context, workflows, rules, tools, templates, and tests so public usage and model-facing behavior match the change.
...
- Do not finish Agent OS behavior changes while README, templates, tests, or tool docs still describe the old behavior.
