...
These tools provide a real SQLite-backed memory backend for Agent OS.
...
Agent Runtime uses the same SQLite database, but it is intentionally separated into `scripts/agent-runtime.py` and documented in `tools/agent-runtime.md`.
